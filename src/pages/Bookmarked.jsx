...
const Bookmarked = () => {
    ...
    const [cardData, setCardData] = useLocalStorage("bookmarkedArticles", []);
    const [originalData, setOriginalData] = useState([]);

    useEffect(() => {
        setCardData(JSON.parse(localStorage.getItem("bookmarkedArticles")));
        setOriginalData(JSON.parse(localStorage.getItem("bookmarkedArticles")));
    },[]);
